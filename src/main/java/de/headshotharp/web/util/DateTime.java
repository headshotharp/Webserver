...
public class DateTime {
	/**
	 * static usage of {@link java.text.SimpleDateFormat SimpleDateFormat} may cause
	 * problems<br />
	...
	public static final String[] MONTH = new String[] { "", "Januar", "Februar", "März", "April", "Mai", "Juni", "Juli",
	...
	/**
	 * trying bugfix: multiple simultanious connection may cause inconsistancy of
	 * SimpleDateFormat (suspicion: static usage) <br />
