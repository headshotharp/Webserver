...
public class ItemShopItemPrice extends ItemShopItem
{
	...
	public String toHTML()
	{
		...
		return "<div class='shop'><h1>" + getName() + disc + "</h1><img " + style + "src='/img/" + getImage() + "'><p>" + getDescription() + "</p><a href='/shop/items/buy/" + getId() + "'><h2>" + buy + "</h2></a><a class='how-to-use' href='#fineprint'>*</a></div>";
	}
