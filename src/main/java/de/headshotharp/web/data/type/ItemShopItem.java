...
public class ItemShopItem
{
	...
	{
		if (type.equalsIgnoreCase("DIAMOND_PICKAXE")) return "mc_pickaxe.png";
		if (type.equalsIgnoreCase("DIAMOND_SPADE")) return "mc_shovel.png";
		if (type.equalsIgnoreCase("DIAMOND_AXE")) return "mc_axe.png";
		if (type.equalsIgnoreCase("DIAMOND_SWORD")) return "mc_sword.png";
		return "mc_items.png";
	}
	...
	public String getDescription()
	{
		...
		{
			str.append("<li>" + item.getEnch().getTrivialName() + " " + CommonUtils.IntToRoman(item.getLevel()) + "</li>");
		}
		str.append("</ul>");
		return str.toString();
	}
