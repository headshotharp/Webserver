...
public class Poll
{
	...
	public Poll(int id, String username, String title, String description, DateTime start, DateTime end, boolean deleted)
	{
		this.id = id;
	...
	public String toAdminListHtml()
	{
		...
		return "<tr><td>" + id + "</td><td>" + title + "</td><td>" + end.format(DateTimeFormat.FORMAT_HUMAN_READABLE_DATE.getSimpleDateFormat()) + "</td><td>" + operation + "</td></tr>";
	}

	public static String toAdminListHtml(List<Poll> list)
	{
		StringBuilder str = new StringBuilder();
		str.append("<table class='table-sm table-bordered'><tr><th>ID</th><th>Titel</th><th>Ende</th><th>Aktion</th></tr>");
		for (Poll p : list)
		{
